...
(FamilyTree._defaultConfig = function (e) {
    ...
    (FamilyTree.templates.john.field_0 = "<text " + FamilyTree.attr.width + '="120" data-text-overflow="multiline" style="font-size: 32px;font-weight:bold;" fill="#aeaeae" x="60" y="170" text-anchor="middle">{val}</text>'),
