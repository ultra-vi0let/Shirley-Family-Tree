...
(FamilyTree._defaultConfig = function (e) {
                        ...
                        if (!a.notifierUI.show(e.notif)) {
                            ...
                            if ((FamilyTree.events.publish("render", [a, n]), (l = n.content), (e = n.res), (l += a.ui.lonely(a.config)), t !== FamilyTree.action.exporting)) {
                                ...
                                var g = e.boundary,
                                    b = g.maxX - g.minX,
                                    T = g.maxY - g.minY,
                                    v = a.ui.svg(b, T, [g.minX, g.minY, b, T], a.config, l, o);
                                r(v);
                            }
                        }
                    },
    ...
    (FamilyTree._defaultConfig = function (e) {
        ...
        return (
            ...
            (t.template = "tommy"),
            (t.mode = "light"),
            (t.minPartnerSeparation = 80),
            (t.partnerChildrenSplitSeparation = 80),
            (t.siblingSeparation = 80),
                            ...
                            case "rotate3d":
                                if (i[m][p]) {
                                    var g = t[m][p],
                                        b = i[m][p],
                                        T = [0, 0, 0, 0];
                                    for (var v in g) T[v] = a((d * s - s) / r) * (b[v] - g[v]) + g[v];
                                    e[m].style.transform = "rotate3d(" + T.toString() + "deg)";
                                }
                                break;
                            case "transform":
                                if (i[m][p]) {
                                    (g = t[m][p]), (b = i[m][p]), (T = [0, 0, 0, 0, 0, 0]);
                                    for (var v in g) T[v] = a((d * s - s) / r) * (b[v] - g[v]) + g[v];
    ...
    (FamilyTree.editUI.prototype.show = function (e, t, i) {
        ...
        for (var n = this.obj.element.querySelectorAll("[bft-input-btn]"), l = 0; l < n.length; l++) {
            n[l].addEventListener("click", function (t) {
                FamilyTree.events.publish("element-btn-click", [r, { input: this.parentNode.querySelector("input"), nodeId: e }]);
            });
        }
        this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", function (e) {
            ...
            a.focus(),
                a.nextElementSibling.addEventListener("click", function (e) {
                    e.stopPropagation(), e.preventDefault();
                    var i = r.obj.element.querySelector('[data-binding="' + a.value + '"]');
                    if (FamilyTree.isNEU(a.value) || i) a.focus();
                    else {
                        var n = FamilyTree.elements.textbox({}, { type: "textbox", label: a.value, binding: a.value }, "280px");
    ...
    (FamilyTree.editUI.prototype._focusElement = function (e) {
        ...
        FamilyTree.isNEU(this.obj.config.editForm.focusBinding) ? FamilyTree.isNEU(e) || (t = document.getElementById(e)) : (t = this.obj.element.querySelector('[data-binding="' + this.obj.config.editForm.focusBinding + '"]')),
            t && (t.focus(), t.value && t.value.length && (t.selectionStart = t.selectionEnd = t.value.length));
    }),
    ...
    (FamilyTree.editUI.prototype.content = function (e, t, i, r, a) {
        ...
        FamilyTree.isNEU(g) && (g = ""), (b = FamilyTree.isNEU(b) ? FamilyTree.icon.user(150, 150, "#8C8C8C", 0, 0) : `<img style="width: 100%;height:100%;border-radius: 50%;" src="${b}"></img>`);
        var w = !t,
            k = t ? "display:none;" : "",
            C = t || !s ? "display:none;" : "",
            I = y.editFormHeaderColor ? `style="background-color:${y.editFormHeaderColor};"` : "",
            S = document.createElement("form");
        if (
            (S.setAttribute("data-bft-edit-form", ""),
            S.classList.add("bft-edit-form"),
            S.classList.add(this.obj.config.mode),
            S.classList.add(f.templateName),
            S.classList.add(FamilyTree.ui._defsIds[f.templateName]),
            Array.isArray(f.tags) && f.tags.length)
        )
            for (T = 0; T < f.tags.length; T++) S.classList.add(f.tags[T]);
        (S.style.display = "flex"), (S.style.opacity = i ? 1 : 0), (S.style.right = i ? 0 : "-20px"), r && (S.style.width = r);
        var N = [],
            A = a
                ? ""
        ...
        return (
            (S.innerHTML = `<div>\n                        <div class="bft-edit-form-header" ${I}>\n                            ${A}\n                            <h1 class="bft-edit-form-title">${g}</h1>\n                            <div id="bft-avatar" class="bft-edit-form-avatar">${b}</div>                        \n                        </div>\n                        <div data-bft-edit-from-btns class="bft-edit-form-instruments">\n                        ${(function () {
                if (a) return "";
                var e = "";
                for (var i in m) {
                    var r = m[i];
                    FamilyTree.isNEU(r) || (w && r.hideIfEditMode) || (t && r.hideIfDetailsMode) || (l && "Edit" == r.text) || (e += `<div data-edit-from-btn='${i}' class="bft-img-button" ${I} title="${r.text}">${r.icon}</div>`);
                }
                return e;
                ...
                for (var e = "", i = 0; i < o.length; i++) {
                    ...
                    if (Array.isArray(r)) {
                        ...
                        for (var a = 0; a < r.length; a++) {
                            ...
                            !FamilyTree.isNEU(s.id) && FamilyTree.isNEU(n) && FamilyTree.isNEU(s.value) && (n = s.id), FamilyTree.isNEU(s.value) || N.push(`${l.label}: ${s.value}`), (e += s.html);
                        }
                        e += "</div>";
                    } else {
    ...
    (FamilyTree.circleMenuUI.prototype._show = function (e, t) {
        ...
        if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
            ...
            if (FamilyTree.isNEU(h) || h.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e) {
                ...
                for (var y = 0, g = Object.keys(f.menu).length, b = 2 * a.nodeCircleMenuButton.radius + 4, T = 2 * Math.PI * b, v = T / g - (2 * a.nodeCircleMenuButton.radius + 2); v < 0; )
                    (b += 8), (v = (T = 2 * Math.PI * b) / g - (2 * a.nodeCircleMenuButton.radius + 2));
                ...
                f.menu)) {
                    ...
                    FamilyTree.isNEU(w) || (C.innerHTML = w);
                    ...
                    I.setAttribute("cx", 0),
                        ...
                        (k.innerHTML += x),
                        h.appendChild(k);
                    var S = k.getElementsByTagName("svg")[0];
                    if ((S.setAttribute("pointer-events", "none"), S)) {
                        var N = parseInt(S.getAttribute("width")),
                            A = parseInt(S.getAttribute("height"));
                        S.setAttribute("x", -N / 2), S.setAttribute("y", -A / 2);
                    }
                    var M = (y * Math.PI) / (g / 2);
                    y++;
                    var L = Math.cos(M) * b,
                    ...
                    this._buttonsInterval.push(
                        FamilyTree.animate(k, { transform: [1, 0, 0, 1, 0, 0] }, { transform: [1, 0, 0, 1, L, E] }, 250, FamilyTree.anim.outBack, function (e) {
    ...
    (FamilyTree._isHTML = function (e) {
        ...
        t.innerHTML = e;
        for (var i = t.childNodes, r = i.length; r--; ) if (1 == i[r].nodeType) return !0;
        return !1;
    }),
    ...
    (FamilyTree.wrapText = function (e, t) {
        ...
        m || (m = "ellipsis");
        var f = m.split("-");
        if ((f.length > 1 && ((a = parseInt(m.split("-")[1])), f.length > 2 && "ellipsis" == f[2] && (n = !0)), !c)) return e;
        if (((c = parseFloat(c)), o || (o = 0), s || (s = 0), o || (d = "start"), "ellipsis" == m)) {
            ...
            return y > 2 ? "<title>" + e + "</title>" + h.textContent : e;
        }
        if (-1 != m.indexOf("multiline")) {
            ...
            T.setAttributeNS(null, "x", o), T.setAttributeNS(null, "y", s), T.setAttributeNS(null, "text-anchor", d), T.appendChild(v), h.appendChild(T);
            y = 1;
            for (var F = 1, x = 1; x < g.length; x++) {
                ...
                if (((T.firstChild.data += " " + g[x]), T.getComputedTextLength() > c)) {
                    ...
                    (T = document.createElementNS(p, "tspan")).setAttributeNS(null, "x", o),
                        T.setAttributeNS(null, "y", s + b * y),
            ...
            if (null != h.innerHTML) (k = h.innerHTML), (h.innerHTML = "");
                ...
                var C = "";
                for (x = h.childNodes.length - 1; x >= 0; x--) (C = XMLSerializer().serializeToString(h.childNodes[x]) + C), h.removeChild(h.childNodes[x]);
                k = C;
            }
            return k;
        }
    ...
    (FamilyTree._json2xml = function (e) {
        for (var t = document.implementation.createDocument("", "", null), i = t.createElement("nodes"), r = 0; r < e.length; r++) {
            ...
            for (var l in n) {
                var o = n[l];
                "tags" == l && (o = o.join()), a.setAttribute(l, o);
            }
            i.appendChild(a);
        }
        ...
        for (var t = new DOMParser().parseFromString(e, "text/xml").getElementsByTagName("node"), i = [], r = 0; r < t.length; r++) {
            for (var a = t[r], n = {}, l = 0; l < a.attributes.length; l++) {
                var o = a.attributes[l],
                    s = o.value;
                "tags" == o.name && (s = s.split(",")), (n[o.name] = s);
            }
            i.push(n);
        }
        return i;
    ...
    (FamilyTree._json2csv = function (e) {
        for (
            ...
            for (var n in e[a]) FamilyTree._arrayContains(t, n) || (t.push(n), (r += n + ","));
    ...
    (FamilyTree.collapsedChildrenCount = function (e, t, i) {
        ...
        for (var r = 0; r < t.childrenIds.length; r++) {
            var a = e.nodes[t.childrenIds[r]];
            a && (!0 === a.collapsed && i++, FamilyTree.collapsedChildrenCount(e, a, i));
        }
        return i;
    }),
    ...
    (FamilyTree.convertCsvToNodes = function (e) {
        for (var t = FamilyTree._csvToArray(e), i = t[0], r = [], a = 1; a < t.length; a++) {
            for (var n = {}, l = 0; l < t[a].length; l++) {
                if ("tags" == i[l] && "" != t[a][l]) t[a][l] = t[a][l].split(",");
                else if ("tags" == i[l] && "" == t[a][l]) continue;
                n[i[l]] = t[a][l];
            }
            "" != n.id.trim() && r.push(n);
        }
    ...
    (FamilyTree.prototype._export = function (e, t) {
        var i = this,
            r = { id: e.nodeId, expandChildren: e.expandChildren };
                    ...
                    FamilyTree._importSetColumnNames(n, function (t) {
                        for (var r = 1; r < i.length; r++) {
                            for (var n = {}, l = 0; l < i[r].length; l++) {
                                var o = t[l],
                                    s = i[r][l];
                                if ("tags" == o && "" != s) s = s.split(",");
                                else if ("tags" == o && "" == s) continue;
                                n[o] = s;
                            }
                            "" != n.id.trim() && a.push(n);
                        }
    ...
    (FamilyTree._importSetColumnNames = function (e, t) {
        if (-1 == e.indexOf("id") || -1 == e.indexOf("pid")) {
            ...
            (b.id = "pid-select"), (b.style.fontSize = "16px"), (b.style.color = "rgb(122, 122, 122)"), (b.style.padding = "5px"), (b.style.margin = "5px"), (b.style.width = "60%"), (b.style.border = "1px solid #aeaeae"), i.appendChild(b);
            for (f = 0; f < e.length; f++) {
                var T;
                (T = document.createElement("option")).setAttribute("value", e[f]);
                u = document.createTextNode(e[f]);
                T.appendChild(u), b.appendChild(T);
            }
    ...
    (FamilyTree.prototype.expandCollapseToLevel = function (e, t, i, r) {
        ...
        var a = { id: e, method: "expandCollapseToLevel" };
        this._draw(!1, FamilyTree.action.collapse, a, r);
    }),
    ...
    (FamilyTree.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (e, t, i) {
        ...
        if (n.draggable) {
            ...
            f.setAttribute("transform", "matrix(1,0,0,1," + (y + b.x) + "," + (g + b.y) + ")"), (f.style.opacity = 0.7);
            var T = function (e, t) {
                    if (null != e) {
                ...
                v = function (t) {
                    if (h) {
                        var i = FamilyTree._getClientXY(t),
                            r = t.target;
                        FamilyTree.isMobile() && (r = document.elementFromPoint(i.x, i.y)), (i.x += b.x * d), (i.y += b.y * d);
                        ...
                        if (s.left || s.right || s.up || s.down) {
                            ...
                            for (
                                ...
                                if (r.hasAttribute && r.hasAttribute(FamilyTree.attr.node_id)) {
                                    var I = r.getAttribute(FamilyTree.attr.node_id);
                                    (c = I), (m = r);
                                    break;
                                }
                                r = r.parentNode;
                            ...
                            if (null != c) {
                                ...
                                for (var S = l.getNode(c), N = FamilyTree.getStParentNodes(S), A = 0; A < N.length; A++) {
                                    var M = l.getNodeElement(N[A].id);
                            ...
                            var L = (i.x - h.x) / d,
                                E = (i.y - h.y) / d;
                            if (((u[4] = y + L), (u[5] = g + E), !e._dragEventFired && (Math.abs(i.x - h.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - h.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                                !1 === FamilyTree.events.publish("drag", [l.nodeCircleMenuUI, { from: I, menuItem: n, menuItemName: a }]) && F(), (e._dragEventFired = !0);
                            f.setAttribute("transform", "matrix(" + u.toString() + ")");
                        }
                    }
                },
                F = function (t) {
                    ...
                    var r = l.getNode(c);
                    FamilyTree.events.publish("drop", [l.nodeCircleMenuUI, { from: s.id, to: r.id, menuItem: n, menuItemName: a }]), T(c, m), p.removeChild(f), (l._gragStartedId = null);
                };
                    ...
                    if (c) {
                        ...
                        if (g.left || g.right || g.up || g.down) {
                            ...
                            if (null != l) {
                                ...
                                for (var C = s.getNode(l), I = FamilyTree.getStParentNodes(C), S = 0; S < I.length; S++) {
                                    var N = s.getNodeElement(I[S].id);
                            ...
                            var A = (i.x - c.x) / f,
                                M = (i.y - c.y) / f;
                            if (((m[4] = p + A), (m[5] = h + M), !e._dragEventFired && (Math.abs(i.x - c.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - c.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                                !1 === FamilyTree.events.publish("drag", [s, k, t]) && b(), (e._dragEventFired = !0);
                            u.setAttribute("transform", "matrix(" + m.toString() + ")");
                        }
                    }
                },
    ...
    (FamilyTree.prototype._mouseDownHandler = function (e, t, i) {
        var r = this;
        FamilyTree.HIDE_EDIT_FORM_ON_PAN && this.editUI.hide(), this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.menuUI.hide(), this.nodeCircleMenuUI.hide();
        ...
        t.touches && t.touches.length > 1 && ((s.type = "pinch"), (s.dist = Math.sqrt((l.x - o.x) * (l.x - o.x) + (l.y - o.y) * (l.y - o.y))));
        ...
        if ("pan" == s.type) {
            ...
            (d.style.display = "inherit"),
                d.setAttribute("transform", "matrix(0,0,0,0," + m + "," + p + ")"),
                FamilyTree.animate(d, { transform: [0, 0, 0, 0, m, p], opacity: 0 }, { transform: [1 / n, 0, 0, 1 / n, m, p], opacity: 1 }, 300, FamilyTree.anim.outBack);
        }
        var h = function (e) {
            ...
            f = function () {
                "pan" == s.type && r.config.sticky
                    ...
                    : "pan" != s.type || r.config.sticky || r._draw(!0, FamilyTree.action.pan),
                    (s = null),
                    (d.style.display = "none"),
                    e.removeEventListener(i.move, h),
    ...
    (FamilyTree.searchUI.prototype.init = function (e) {
        ...
        i.classList.add("bft-search"), (i.style.right = this.obj.config.padding - 10 + "px"), (i.style.top = this.obj.config.padding - 10 + "px");
        var r = FamilyTree.elements.textbox({}, { label: FamilyTree.SEARCH_PLACEHOLDER }, "320px");
        (i.innerHTML += r.html), (this.searchTableWrapper = document.createElement("div")), i.appendChild(this.searchTableWrapper);
    ...
    (FamilyTree.searchUI.prototype._serverSearch = function (e) {
        var t = this,
            ...
            a = `<table border="0" cellspacing="0" cellpadding="0">\n                    <tbody>\n                        ${(function () {
                for (var e = "", a = 0; a < i.length && !(a >= FamilyTree.SEARCH_RESULT_LIMIT); a++) {
                    var n = i[a],
                        l = "";
                    if (r) {
                        var o = t.obj._get(n.id);
                        "function" == typeof r ? (l = r(t.obj, t.obj.getNode(n.id), o)) : o[r] && (l = o[r]);
                    }
                    var s = "",
                        d = "";
                    t.obj.config.searchDisplayField == n.__searchField
                        ...
                        ? ((s = n[t.obj.config.searchDisplayField]), FamilyTree.isNEU(s) && (s = ""), (d = n.__searchMarks))
                        : (s = n.__searchMarks),
                        (e += FamilyTree.searchUI.createItem(l, n.id, s, d));
                }
                return e;
            })()}  \n                    </tbody>\n                </table>`;
        this.searchTableWrapper.innerHTML = a;
        for (var n = this.obj.element.querySelectorAll("[data-search-item-id]"), l = 0; l < n.length; l++)
            n[l].addEventListener("click", function () {
                if (!1 !== FamilyTree.events.publish("searchclick", [t.obj, this.getAttribute("data-search-item-id")])) {
    ...
    (FamilyTree.manager.prototype.read = function (e, t, i, r, a, n, l, o) {
        ...
        FamilyTree.state._get(this.config.state, t, i, function (d) {
            (s.state = d),
                (s.action = a),
                (s.actionParams = n),
                a != FamilyTree.action.init || !s.state || (n && n.method && "fit" == n.method) ? ((s.viewBox = r), (s.vbIsInitializedFromState = !1)) : ((s.viewBox = s.state.vb), (s.vbIsInitializedFromState = !0));
            var c = s.maxX,
                m = s.maxY,
                p = s.minX,
                h = s.minY,
    ...
    (FamilyTree.manager._setCollpasedProperty = function (e, t, i, r, a, n, l) {
        null == e.collapsed && t.collapse && t.collapse.allChildren ? (e.collapsed = !0) : null == e.collapsed && (e.collapsed = !1),
            ...
            a == FamilyTree.action.init && null != l
                ...
                : (a != FamilyTree.action.centerNode && a != FamilyTree.action.insert && a != FamilyTree.action.expand && a != FamilyTree.action.collapse) || (r.has(e.id) && (e.collapsed = !1));
    }),
    (FamilyTree.manager._initNode = function (e, t, i, r, a, n, l) {
        ...
        if (
            (e.min || d != FamilyTree.action.minimize || ((c.all || c.id == e.id) && (e.min = !0)),
            !0 === e.min && d == FamilyTree.action.maximize && (c.all || c.id == e.id) && (e.min = !1),
            d == FamilyTree.action.init && null != m && (e.min = m.min.has(e.id)),
            !e.min)
        )
            for (h = 0; h < e.stChildrenIds.length; h++) {
                ((f = t[e.stChildrenIds[h]]).stParent = e), e.stChildren.push(f);
            }
        ...
        var b = { node: e };
        FamilyTree.events.publish("node-initialized", [l, b]), FamilyTree.events.publish("node-created", [e]);
    }),
    (FamilyTree.manager._iterate = function (e, t, i, r, a, n, l, o, s, d, c, m) {
        ...
        for (var b = 0; b < t.stChildren.length; b++) {
            var T = "";
            ...
            a.push(t.stChildren[b].id), FamilyTree.manager._iterate(e, t.stChildren[b], i, 0, a, n, l, o, T, d, c, m);
        }
        r++;
        for (b = 0; b < t.children.length; b++) FamilyTree.manager._iterate(e, t.children[b], i, r, a, n, l, o, s, d, c, m);
    }),
    (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
        for (var s = i.nodes, d = [], c = 0; c < s.length; c++) {
            var m,
                p = s[c];
            (m = FamilyTree.STRING_TAGS ? (p.tags ? p.tags.split(",") : []) : Array.isArray(p.tags) ? p.tags.slice(0) : []), o.filterUI.addFilterTag(p) && m.push("filter");
            var h = FamilyTree._getTemplate(m, i.tags, i.template),
                f = new FamilyTree.node(p.id, p.pid, m, h);
            FamilyTree.isNEU(p.ppid) || (f.ppid = p.ppid), FamilyTree.isNEU(p.stpid) || (f.stpid = p.stpid), null != i.orderBy && (f.order = FamilyTree.manager._getOrderFieldValue(p, i.orderBy)), (e[p.id] = f), d.push(p.id);
        }
        null != i.orderBy &&
            d.sort(function (t, r) {
                var a = e[t].order,
        ...
        for (c = 0; c < d.length; c++) {
            var u = d[c],
                ...
                g = e[f.stpid],
                b = e[f.pid];
            if ((g || (f.stpid = null), b || (f.pid = null), g)) {
                var T = n ? n[g.id] : null;
                T && (g.min = T.min), g.stChildrenIds.push(f.id);
            } else b ? (y && ((f.collapsed = y.collapsed), (f.min = y.min)), b.childrenIds.push(f.id)) : (y && ((f.collapsed = y.collapsed), (f.min = y.min)), t.push(f), l.push(f.id));
            r == FamilyTree.action.init && (f.min = FamilyTree._getMin(f, i));
        }
    }),
    (FamilyTree.manager._createNodes = function (e) {
        ...
        if ((FamilyTree.manager.__createNodes(o, s, t, r, a, n, d, e), null != t.roots)) {
            ...
            for (var c = 0; c < t.roots.length; c++) {
                ...
                if (m && r == FamilyTree.action.centerNode) {
                    ...
                    for (var h = o[a.id]; null != h.pid || null != h.stpid; ) h = null == h.pid && null != h.stpid ? o[h.stpid] : o[h.pid];
                    p == h && (m = p);
                }
                if (m) {
                    ...
                    if (!f) {
                        if (!FamilyTree.isNEU(m.pid)) (j = (T = o[m.pid]).childrenIds.indexOf(m.id)) > -1 && T.childrenIds.splice(j, 1);
                        s.push(m);
                    }
                }
            }
        ...
        if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == l)
            ...
            var b;
            b = r == FamilyTree.action.expand ? a.ids : a.expandIds;
            for (c = 0; c < b.length; c++) for (var T = o[(g = o[b[c]]).pid]; T; ) y.push(T.id), null == T.pid && null != T.stpid ? ((T = o[T.stpid]).min = !1) : (T = o[T.pid]);
            ...
            for (var v = o[a.id]; v; ) {
                if ((y.push(v.id), a.options.parentState === FamilyTree.COLLAPSE_PARENT_NEIGHBORS && v))
                    for (c = 0; c < v.childrenIds.length; c++) {
                        (R = o[v.childrenIds[c]]).collapsed = !0;
                    }
        ...
        var _ = [],
            ...
            C = {},
            I = [];
        for (c = 0; c < s.length; c++) FamilyTree.manager._iterate(s[c], s[c], o, 0, _, w, k, C, "", y, I, e);
        ...
        for (c = 0; c < I.length; c++) {
            ...
            for (F = 0; F < g.children.length; F++) {
                (R = g.children[F]).isAssistant
                    ? S.push(R.id)
                    : -1 != R.tags.indexOf("right-partner")
                    ? ((R.isPartner = 1), (R.children = []), N.push(R.id))
                    : -1 != R.tags.indexOf("left-partner")
                    ? ((R.isPartner = 2), (R.children = []), A.push(R.id))
                    : -1 == R.tags.indexOf("partner") || L % 2
                    ? -1 != R.tags.indexOf("partner") && L % 2
                        ? ((R.isPartner = 2), (R.children = []), A.push(R.id), L++)
                        : R.parentPartner
                        ? (M[R.parentPartner.id] || (M[R.parentPartner.id] = []), M[R.parentPartner.id].push(R.id))
                        : S.push(R.id)
                    : ((R.isPartner = 1), (R.children = []), N.push(R.id), L++);
            }
            g.children = [];
            var P = [];
            for (F = 0; F < N.length; F++) {
                M[(R = o[N[F]]).id] ? g.children.push(R) : g.children.splice(0, 0, R);
                for (var z = 0; z < R.childrenIds.length; z++) P.push(R.childrenIds[z]);
            }
            var D = [];
            for (F = 0; F < A.length; F++) {
                M[(R = o[A[F]]).id] ? g.children.push(R) : g.children.splice(0, 0, R);
                for (z = 0; z < R.childrenIds.length; z++) D.push(R.childrenIds[z]);
            }
            for (F = 0; F < D.length; F++) {
                (R = o[D[F]]).collapsed || ((R.parentPartner = R.parent), (R.parent = g), (R.isChildOfPartner = !0), g.children.push(R));
            }
            for (F = A.length - 1; F >= 0; F--) if (M[A[F]]) for (u = 0; u < M[A[F]].length; u++) g.children.push(o[M[A[F]][u]]), E++, -1 == B.indexOf(A[F]) && B.push(A[F]);
            for (F = 0; F < S.length; F++) {
                var R = o[S[F]];
                g.children.push(R);
            }
            for (F = 0; F < N.length; F++) if (M[N[F]]) for (u = 0; u < M[N[F]].length; u++) g.children.push(o[M[N[F]][u]]), U++, -1 == O.indexOf(N[F]) && O.push(N[F]);
            for (F = 0; F < P.length; F++) {
                (R = o[P[F]]).collapsed || ((R.parentPartner = R.parent), (R.parent = g), (R.isChildOfPartner = !0), g.children.push(R));
            }
        ...
        for (c = 0; c < k.length; c++) {
            if ((re = i[(g = o[k[c]]).lcn ? g.lcn : "base"]).layout == FamilyTree.normal || !C[g.pid])
                for (F = 0; F < g.subLevels; F++) {
                    var j,
                        H = new FamilyTree.node(g.id + "_sub_level_index_" + F, g.pid, [], "subLevel");
                    if ((FamilyTree.manager._initDinamicNode(H, g.lcn), (T = g.parent)))
                        (j = T.children.indexOf(g)) > -1 && (T.children.splice(j, 1), T.children.splice(j, 0, H)), H.children.push(g), (H.parent = T), (g.parent = H), (o[H.id] = H);
                }
        }
        for (var $ in w) {
            (T = o[$]).hasAssistants = !0;
            H = new FamilyTree.node(T.id + "_split_assitant_0", T.id, ["assistant"], "split");
            FamilyTree.manager._initDinamicNode(H, T.lcn, !0), (o[H.id] = H);
            var q = [];
            for (F = T.children.length - 1; F >= 0; F--) {
                (R = T.children[F]).isAssistant
                    ? ((R.parent = null), T.children.splice(F, 1), q.splice(0, 0, R.id))
                    : R.isPartner ||
                      (R.parent && C[R.parent.id] && H && R.parent.id != H.id && (Object.defineProperty(C, H.id, Object.getOwnPropertyDescriptor(C, R.parent.id)), delete C[R.parent.id]),
                      (R.parent = H),
                      H.children.unshift(R),
                      T.children.splice(F, 1));
            }
            if (q.length % 2) {
                var Y = o[q[q.length - 1]],
                    X = new FamilyTree.node(Y.id + "_mirror", Y.pid, [], "mirror");
                FamilyTree.manager._initDinamicNode(X, Y.lcn, !0), (Y._m = X.id), (X.isAssistant = !0), (X.w = Y.w), (X.h = Y.h), (o[X.id] = X), q.splice(q.length - 1, 0, X.id);
            }
            var V = 1;
            for (F = q.length - 1; F >= 0; F--)
                if (F % 2 && F != q.length - 1) {
                    var W = new FamilyTree.node(T.id + "_split_assitant_" + V, null, [], "split");
                    FamilyTree.manager._initDinamicNode(W, T.lcn, !0), (o[W.id] = W), q.splice(F, 0, W.id), V++;
                } else F % 2 && q.splice(F, 0, H.id);
            for (F = 0; F < q.length; F += 3) {
                var G = null;
                G = 0 == F ? T : o[q[F - 2]];
                var K = o[q[F]],
                    J = o[q[F + 1]],
        ...
        var Q = !1;
        for (var ee in i) {
            if ((re = i[ee]).layout == FamilyTree.mixed || re.layout == FamilyTree.tree || re.layout == FamilyTree.treeRightOffset || re.layout == FamilyTree.treeLeftOffset) {
                Q = !0;
                break;
            }
        }
        ...
        if (Q || te) {
            ...
            for (var $ in C) {
                var re;
                if ((re = i[(T = o[$]).lcn ? T.lcn : "base"]).layout == FamilyTree.mixed || re.layout == FamilyTree.tree || re.layout == FamilyTree.treeRightOffset || re.layout == FamilyTree.treeLeftOffset || te)
                    if (
                        ((ie.pnode = T),
                        (ie.layout = re.layout),
                        (ie.childrenIds = C[$]),
                        (ie.lastChildrenPidIds = C),
                        FamilyTree.events.publish("node-layout", [e, ie]),
                        FamilyTree.events.publish("layout", [ie]),
                        ie.layout == FamilyTree.mixed)
                    ) {
                        var ae = ie.childrenIds;
                        for (c = ae.length - 1; c >= 0; c--) {
                            (T = (R = o[ae[c]]).parent), (R.layout = FamilyTree.mixed);
                            for (F = T.children.length - 1; F >= 0; F--)
                                if (R.id == T.children[F].id) {
                                    T.children.splice(F, 1);
                                    break;
                                }
                            if (c > 0) {
                                var ne = o[ae[c - 1]];
                                (R.parent = ne), (R.layout = FamilyTree.mixed), ne.children.push(R);
                        ...
                        H = new FamilyTree.node(T.id + "_split_0", T.id, [], "split");
                        FamilyTree.manager._initDinamicNode(H, T.lcn), (o[H.id] = H), (H.layout = FamilyTree.tree);
                        var le = [];
                        for (c = ie.childrenIds.length - 1; c >= 0; c--) {
                            for (R = o[ie.childrenIds[c]], F = 0; F < T.children.length; F++) T.children[F].id == R.id && T.children.splice(F, 1);
                            if (((R.parent = null), (R.layout = FamilyTree.tree), ie.layout == FamilyTree.treeRightOffset && le.splice(0, 0, R.id), ie.layout == FamilyTree.treeLeftOffset || ie.layout == FamilyTree.treeRightOffset)) {
                                var oe = new FamilyTree.node(R.id + "_mirror", null, [], "mirror");
                                FamilyTree.manager._initDinamicNode(oe, R.lcn), (oe.layout = FamilyTree.tree), (o[oe.id] = oe), le.splice(0, 0, oe.id);
                            }
                            ie.layout != FamilyTree.treeRightOffset && le.splice(0, 0, R.id);
                        }
                        for (V = 1, F = le.length - 1; F >= 0; F--)
                            if (F % 2 && F != le.length - 1) {
                                W = new FamilyTree.node(T.id + "_split_" + V, null, [], "split");
                                FamilyTree.manager._initDinamicNode(W, T.lcn), (W.layout = FamilyTree.tree), (o[W.id] = W), le.splice(F, 0, W.id), V++;
                            } else F % 2 && le.splice(F, 0, H.id);
                        for (F = 0; F < le.length; F += 3) {
                            G = null;
                            0 == F && (G = T);
                            (K = o[le[F]]), (J = o[le[F + 1]]), (Z = o[le[F + 2]]);
                            0 != F && (G = o[le[F - 3]]),
                                0 == F || J || (G = o[le[F - 2]]),
                                (K.parent = G),
                                G.children.push(K),
                                J && (0 != F && (G = o[le[F - 2]]), (J.parent = G), G.children.push(J)),
                                Z && (0 != F && (G = o[le[F - 1]]), (Z.parent = G), G.children.push(Z));
                        }
                    }
            }
        }
    ...
    (FamilyTree.manager._getResponse = function (e, t, i, r, a, n, l, o, s, d, c, m, p, h, f) {
        var u = d[0],
            ...
            T = a - l + 2 * r.padding,
            v = n - o + 2 * r.padding,
            F = FamilyTree.getScale(s, e, t, r.scaleInitial, r.scaleMax, r.scaleMin, T, v);
        if (
            ((g.top = o - r.padding),
            (g.left = l - r.padding),
        ...
        if (c == FamilyTree.action.centerNode || c == FamilyTree.action.maximize) {
            var C = p[m.id];
            1 == m.options.horizontal && (s[0] = C.x + C.w / 2 - s[2] / 2),
                1 == m.options.vertical && (s[1] = C.y + C.h / 2 - s[3] / 2),
                r.sticky &&
                    (s[0] < g.left && s[0] < g.right && (s[0] = g.left > g.right ? g.right : g.left),
                    s[0] > g.right && s[0] > g.left && (s[0] = g.left > g.right ? g.left : g.right),
                    s[1] < g.top && s[1] < g.bottom && (s[1] = g.top > g.bottom ? g.bottom : g.top),
        ...
        if (c == FamilyTree.action.insert || c == FamilyTree.action.expand || c == FamilyTree.action.collapse || c == FamilyTree.action.update || c == FamilyTree.action.centerNode || c == FamilyTree.action.maximize) {
            var I = null;
            if (c == FamilyTree.action.insert && m && null != m.insertedNodeId && null != m.insertedNodeId) I = p[m.insertedNodeId];
            else if (c == FamilyTree.action.update && m && null != m.visId && null != m.visId) I = p[m.visId];
                ...
                if (c == FamilyTree.action.centerNode || c == FamilyTree.action.maximize) {
                    switch (r.orientation) {
                        ...
                        case FamilyTree.orientation.bottom:
                        case FamilyTree.orientation.bottom_left:
                            m.options.vertical || (I = p[m.id]);
                            break;
                        case FamilyTree.orientation.right:
                        case FamilyTree.orientation.right_top:
                        case FamilyTree.orientation.left:
                        case FamilyTree.orientation.left_top:
                            m.options.horizontal || (I = p[m.id]);
                    }
                    I && (I = FamilyTree.manager._getMostDeepChild(I, p));
                }
            } else (I = p[m.id]), (I = FamilyTree.manager._getMostDeepChild(I, p));
            if (!FamilyTree.FIXED_POSITION_ON_CLICK && I)
                switch (r.orientation) {
                    case FamilyTree.orientation.top:
                    case FamilyTree.orientation.top_left:
                        var S = I.y + I.h - s[3] + r.padding;
                        s[1] < S && (s[1] = S);
                        break;
                    case FamilyTree.orientation.bottom:
                    case FamilyTree.orientation.bottom_left:
                    ...
                    case FamilyTree.orientation.left:
                    case FamilyTree.orientation.left_top:
                        S = I.x + I.w - s[2] + r.padding;
                        s[0] < S && (s[0] = S);
                }
        }
        for (var N = 0; N < d.length; N++) FamilyTree.manager._iterate2(d[N], p, r, s, c, m, y, h, i, b);
        return { animations: b, boundary: g, viewBox: s, visibleNodeIds: y, nodes: p, allFields: FamilyTree.manager.getAllFields(r) };
    }),
    ...
    (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
        for (var s = i.nodes, d = [], c = [], m = {}, p = {}, h = 0; h < s.length; h++) {
            var f,
                u = s[h];
            (f = FamilyTree.STRING_TAGS ? (u.tags ? u.tags.split(",") : []) : Array.isArray(u.tags) ? u.tags.slice(0) : []), o.filterUI.addFilterTag(u) && f.push("filter"), u.gender && f.push(u.gender);
            var y = FamilyTree._getTemplate(f, i.tags, i.template);
            u.templateName && (y = u.templateName);
            var g = new FamilyTree.node(u.id, u.pid, f, y);
            (g.ftChildrenIds = []),
                (g.rids = []),
                FamilyTree.isNEU(u.ppid) || (g.ppid = u.ppid),
                FamilyTree.isNEU(u.stpid) || (g.stpid = u.stpid),
                FamilyTree.isNEU(u.mid) || (g.mid = u.mid),
                FamilyTree.isNEU(u.fid) || (g.fid = u.fid),
                FamilyTree.isNEU(u.gender) || (g.gender = u.gender),
                Array.isArray(u.pids) ? (g.pids = u.pids) : (g.pids = []),
                null != i.orderBy && (g.order = FamilyTree.manager._getOrderFieldValue(u, i.orderBy)),
                (e[u.id] = g),
                d.push(u.id),
                FamilyTree.isNEU(g.stpid)
                    ? (FamilyTree.isNEU(g.mid) || (m[g.mid] || (m[g.mid] = []), m[g.mid].push(g.id)),
                      FamilyTree.isNEU(g.fid) || (m[g.fid] || (m[g.fid] = []), m[g.fid].push(g.id)),
                      FamilyTree.isNEU(g.mid) && FamilyTree.isNEU(g.fid) && FamilyTree.isNEU(g.stpid) && (c.has(g.id) || c.push(g.id)))
                    : (p[g.stpid] || (p[g.stpid] = []), p[g.stpid].push(g.id));
        }
        null != i.orderBy &&
            d.sort(function (t, r) {
                var a = e[t].order,
        ...
        for (h = 0; h < c.length; h++) {
            ...
            if (b) {
                var T = [];
                FamilyTree.manager._iterateSetRootIds(b.id, b.id, p, m, e, T), l.push(T);
            }
        }
        for (h = 0; h < l.length; h++)
            for (var v = 0; v < l.length; v++)
                if (v != h) {
                    for (var F = l[h], x = l[v], _ = !1, w = 0; w < F.length; w++)
                        if (x.has(F[w])) {
                            _ = !0;
                            break;
                        }
                    _ && ((l[h] = F.concat(x).unique()), (l[v] = []));
                }
        for (h = l.length - 1; h >= 0; h--) l[h].length || l.splice(h, 1);
        if (!i.roots || !i.roots.length) {
            i.roots = [];
            for (h = l.length - 1; h >= 0; h--) i.roots.push(l[h][0]);
        }
        for (h = 0; h < i.roots.length; h++) FamilyTree.manager._iterateFT(i.roots[h], p, m, e, n, t, r, a, i);
    }),
            ...
            if (g) {
                ...
                if (
                    ...
                    for (var T = 0; T < i[g.id].length; T++) {
                        var v = r[i[g.id][T]];
                        v && (FamilyTree.isNEU(v.fid) || FamilyTree.isNEU(v.mid)) && FamilyTree.manager._iterateFT(i[g.id][T], t, i, r, a, n, l, o, s);
                    }
                c.childrenIds.push(g.id), (g.ftChildrenIds = c.ftChildrenIds);
            }
        }
        if (t[e]) for (T = 0; T < t[e].length; T++) FamilyTree.manager._iterateFT(t[e][T], t, i, r, a, n, l, o, s);
        if (i[e]) for (T = 0; T < i[e].length; T++) FamilyTree.manager._iterateFT(i[e][T], t, i, r, a, n, l, o, s);
    }),
    (FamilyTree.manager.getAllFields = function (e) {
        var t = [FamilyTree.TAGS];
        for (var i in e.nodeBinding) t.push(e.nodeBinding[i]);
    ...
    (FamilyTree.templates.base = {
        ...
        link: '<path stroke-linejoin="round" stroke="#CCBCD8" stroke-width="5px" fill="none" d="{rounded}" />',
    ...
    (FamilyTree.templates.john.defs = `<style>                          \n                                        .{randId} .bft-edit-form-header, .{randId} .bft-img-button{\n                                            background-color: #aeaeae;\n                                        }\n                                        .{randId}.male .bft-edit-form-header, .{randId}.male .bft-img-button{\n                                            background-color: #E9EFAF;\n                                        }        \n                                        .{randId}.male div.bft-img-button:hover{\n                                            background-color: #EFB9D9;\n                                        }\n                                        .{randId}.female .bft-edit-form-header, .{randId}.female .bft-img-button{\n                                            background-color: #EFB9D9;\n                                        }        \n                                        .{randId}.female div.bft-img-button:hover{\n                                            background-color: #E9EFAF;\n                                        }\n                                    </style>\n                                    <clipPath id="john_img_0"><rect  x="6" y="6" rx="54" ry="54" width="108" height="108"></rect></clipPath>\n                                    ${FamilyTree.gradientCircleForDefs(
        "circle",
        "#aeaeae",
        60,
        5
    )}\n                                    ${FamilyTree.gradientCircleForDefs("male_circle", "#E9EFAF", 60, 5)}\n                                    ${FamilyTree.gradientCircleForDefs("female_circle", "#EFB9D9", 60, 5)}`),
    (FamilyTree.templates.john.field_0 = "<text " + FamilyTree.attr.width + '="120" data-text-overflow="multiline" style="font-family: nameFont; font-size: 32px;font-weight:bold;" fill="#876D9B" x="60" y="170" text-anchor="middle">{val}</text>'),
    ...
    (FamilyTree.templates.john_male.ripple = { radius: 60, color: "#E9EFAF", rect: null }),
    ...
    (FamilyTree.templates.john_female.ripple = { radius: 60, color: "#EFB9D9", rect: null }),
    (FamilyTree.templates.tommy = Object.assign({}, FamilyTree.templates.base)),
    (FamilyTree.templates.tommy.defs =
        "<style>                          \n                                        .{randId} .bft-edit-form-header, .{randId} .bft-img-button{\n                                            background-color: #aeaeae;\n                                        }\n                                        .{randId}.male .bft-edit-form-header, .{randId}.male .bft-img-button{\n                                            background-color: #039BE5;\n                                        }        \n                                        .{randId}.male div.bft-img-button:hover{\n                                            background-color: #F57C00;\n                                        }\n                                        .{randId}.female .bft-edit-form-header, .{randId}.female .bft-img-button{\n                                            background-color: #F57C00;\n                                        }        \n                                        .{randId}.female div.bft-img-button:hover{\n                                            background-color: #039BE5;\n                                        }\n                                    </style>"),
    (FamilyTree.templates.tommy.field_0 = "<text " + FamilyTree.attr.width + '="230" style="font-familyfont-size: 18px;font-weight:bold;" fill="#ffffff" x="10" y="90" text-anchor="start">{val}</text>'),
    ...
    (FamilyTree.ui = {
        ...
        node: function (e, t, i, r, a, n, l, o, s, d) {
            ...
            for (var h in l) {
                var f,
                    u = l[h];
                if ((t && (f = t[u]), "function" == typeof u && (f = u(d, e, t)), (p.value = f), (p.element = c[h]), (p.name = u), !1 !== FamilyTree.events.publish("field", [d, p])))
                    if (null != p.value && null != p.value && null != p.element)
                        FamilyTree._lblIsImg(r, h) || "string" != typeof p.value || (p.value = FamilyTree.wrapText(p.value, p.element)),
                            (m += p.element
            ...
            var y = FamilyTree._getPosition(i, e, a, n),
                g = "node";
            Array.isArray(e.tags) && e.tags.length && (g += " " + e.tags.join(" ")), e.layout && (g += " tree-layout");
            var b = "";
            e.lcn && (b = 'lcn="' + e.lcn + '"');
            var T = FamilyTree.nodeOpenTag.replace("{lcn}", b).replace("{id}", e.id).replace("{class}", g).replace("{sl}", e.sl).replace("{level}", e.level).replace("{x}", y.x).replace("{y}", y.y),
                v = FamilyTree._getOpacity(i, e);
            return (m = (T = T.replace("{opacity}", v)) + (m += FamilyTree.ui.nodeBtns(r, e, o, c, d)) + FamilyTree.grCloseTag);
        },
        ...
        expandCollapseBtn: function (e, t, i, r, a) {
            ...
            if (r !== FamilyTree.action.exporting && !t.isSplit) {
                ...
                if (t.childrenIds.length > 0) {
                    if (t.hasPartners) {
                        for (var c = !1, m = 0; m < t.children.length; m++) t.children[m].parentPartner || t.children[m].isPartner || (c = !0);
                        if (!c) return "";
                    }
            ...
            var h = { html: n, node: t };
            return FamilyTree.events.publish("renderbuttons", [e, h]), h.html;
        },
        link: function (e, t, i, r, a, n) {
            ...
            for (u = 0; u < e.children.length; u++) {
                var y = e.children[u],
                    ...
                    T = (s = FamilyTree.t(y.templateName, y.min, i)).link;
                if (y.isChildOfPartner)
                    switch (o.orientation) {
                        case FamilyTree.orientation.top:
                        case FamilyTree.orientation.top_left:
                            var v = 1 == y.layout ? void 0 : g.minY - (g.minY - h.maxY) / 2;
                            b = FamilyTree.ui._linkTopToBottom(y.parentPartner, y, s, c, v);
                            break;
                        case FamilyTree.orientation.bottom:
                        case FamilyTree.orientation.bottom_left:
                            v = 1 == y.layout ? void 0 : g.maxY - (g.maxY - h.minY) / 2;
                            b = FamilyTree.ui._linkBottomToTop(y.parentPartner, y, s, c, v);
                            break;
                        case FamilyTree.orientation.right:
                        case FamilyTree.orientation.right_top:
                            v = 1 == y.layout ? void 0 : g.maxX - (g.maxX - h.minX) / 2;
                            b = FamilyTree.ui._linkRightToLeft(y.parentPartner, y, s, c, v);
                            break;
                        case FamilyTree.orientation.left:
                        case FamilyTree.orientation.left_top:
                            v = 1 == y.layout ? void 0 : g.minX - (g.minX - h.maxX) / 2;
                            b = FamilyTree.ui._linkLeftToRight(y.parentPartner, y, s, c, v);
                    }
                else if (f && -1 != f.ids.indexOf(y.id))
                    switch (o.orientation) {
                        case FamilyTree.orientation.top:
                        case FamilyTree.orientation.top_left:
                            b = FamilyTree.ui._linkPpTop(f, e, y, g, h, s);
                            break;
                        case FamilyTree.orientation.bottom:
                        case FamilyTree.orientation.bottom_left:
                            b = FamilyTree.ui._linkPpBottom(f, e, y, g, h, s);
                            break;
                        case FamilyTree.orientation.right:
                        case FamilyTree.orientation.right_top:
                            b = FamilyTree.ui._linkPpRight(f, e, y, g, h, s);
                            break;
                        case FamilyTree.orientation.left:
                        case FamilyTree.orientation.left_top:
                            b = FamilyTree.ui._linkPpLeft(f, e, y, g, h, s);
                    }
                else if ((y.isAssistant || 2 == y.layout) && y.rightNeighbor && y.rightNeighbor.isSplit)
                    switch (o.orientation) {
                        case FamilyTree.orientation.top:
                        case FamilyTree.orientation.top_left:
                        case FamilyTree.orientation.bottom:
                        case FamilyTree.orientation.bottom_left:
                            b = FamilyTree.ui._linkRightToLeft(y.rightNeighbor, y, s, c);
                            break;
                        case FamilyTree.orientation.right:
                        case FamilyTree.orientation.right_top:
                        case FamilyTree.orientation.left:
                        case FamilyTree.orientation.left_top:
                            b = FamilyTree.ui._linkBottomToTop(y.rightNeighbor, y, s, c);
                    }
                else if ((y.isAssistant || 2 == y.layout) && y.leftNeighbor && y.leftNeighbor.isSplit)
                    switch (o.orientation) {
                        case FamilyTree.orientation.top:
                        case FamilyTree.orientation.top_left:
                        case FamilyTree.orientation.bottom:
                        case FamilyTree.orientation.bottom_left:
                            b = FamilyTree.ui._linkLeftToRight(y.leftNeighbor, y, s, c);
                            break;
                        case FamilyTree.orientation.right:
                        case FamilyTree.orientation.right_top:
                        case FamilyTree.orientation.left:
                        case FamilyTree.orientation.left_top:
                            b = FamilyTree.ui._linkTopToBottom(y.leftNeighbor, y, s, c);
                    }
                else
                    switch (o.orientation) {
                        case FamilyTree.orientation.top:
                        case FamilyTree.orientation.top_left:
                            if (1 == y.isPartner) b = FamilyTree.ui._linkLeftToRight(e, y, s, m);
                            else if (2 == y.isPartner) b = FamilyTree.ui._linkRightToLeft(e, y, s, m);
                            else {
                                v = 1 == y.layout ? void 0 : g.minY - (g.minY - h.maxY) / 2;
                                b = FamilyTree.ui._linkTopToBottom(e, y, s, c, v);
                            }
                            break;
                        case FamilyTree.orientation.bottom:
                        case FamilyTree.orientation.bottom_left:
                            if (1 == y.isPartner) b = FamilyTree.ui._linkLeftToRight(e, y, s, m);
                                ...
                                v = 1 == y.layout ? void 0 : g.maxY - (g.maxY - h.minY) / 2;
                                b = FamilyTree.ui._linkBottomToTop(e, y, s, c, v);
                            }
                            break;
                        case FamilyTree.orientation.right:
                        case FamilyTree.orientation.right_top:
                            if (1 == y.isPartner) b = FamilyTree.ui._linkTopToBottom(e, y, s, m);
                            else if (2 == y.isPartner) b = FamilyTree.ui._linkBottomToTop(e, y, s, m);
                            else {
                                v = 1 == y.layout ? void 0 : g.maxX - (g.maxX - h.minX) / 2;
                                b = FamilyTree.ui._linkRightToLeft(e, y, s, c, v);
                            }
                            break;
                        case FamilyTree.orientation.left:
                        case FamilyTree.orientation.left_top:
                            if (1 == y.isPartner) b = FamilyTree.ui._linkTopToBottom(e, y, s, m);
                                ...
                                v = 1 == y.layout ? void 0 : g.minX - (g.minX - h.maxX) / 2;
                                b = FamilyTree.ui._linkLeftToRight(e, y, s, c, v);
                            }
                    }
                if (-1 != T.indexOf("{rounded}"))
                    if ((b.xa == b.xb && b.xa == b.xc && b.xa == b.xd) || (b.ya == b.yb && b.ya == b.yc && b.ya == b.yd)) T = T.replace("{rounded}", "M" + b.xa + "," + b.ya + " L" + b.xd + "," + b.yd);
                    else if (Math.abs(b.xa - b.xd) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(b.xa - b.xc) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(b.xa - b.xb) <= FamilyTree.LINK_ROUNDED_CORNERS)
                        T = T.replace("{rounded}", "M" + b.xa + "," + b.ya + " L" + b.xa + "," + b.yd);
                    else if (Math.abs(b.ya - b.yd) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(b.ya - b.yc) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(b.ya - b.yb) <= FamilyTree.LINK_ROUNDED_CORNERS)
                        T = T.replace("{rounded}", "M" + b.xa + "," + b.ya + " L" + b.xd + "," + b.ya);
                    else {
                        var F = FamilyTree.ui._roundedEdge(b.xa, b.ya, b.xb, b.yb, b.xc, b.yc),
                            x = FamilyTree.ui._roundedEdge(b.xb, b.yb, b.xc, b.yc, b.xd, b.yd);
                        T = T.replace(
                            "{rounded}",
                            "M" +
                                F.x1 +
                    ...
                    T =
                        -1 != T.indexOf("{edge}")
                            ? T.replace("{edge}", "M" + b.xa + "," + b.ya + " " + b.xb + "," + b.yb + " " + b.xc + "," + b.yc + " L" + b.xd + "," + b.yd)
                            : -1 != T.indexOf("{curve}")
                            ? T.replace("{curve}", "M" + b.xa + "," + b.ya + " C" + b.xb + "," + b.yb + " " + b.xc + "," + b.yc + " " + b.xd + "," + b.yd)
                            : T.replaceAll("{xa}", b.xa).replaceAll("{ya}", b.ya).replaceAll("{xb}", b.xb).replaceAll("{yb}", b.yb).replaceAll("{xc}", b.xc).replaceAll("{yc}", b.yc).replaceAll("{xd}", b.xd).replaceAll("{yd}", b.yd);
                d.push(
                ...
                var _ = { node: e, cnode: y, p: b, html: T, action: n };
                FamilyTree.events.publish("render-link", [t, _]), d.push(_.html);
                var w = "";
                for (var k in t.config.linkBinding) {
                    var C = t.config.linkBinding[k],
                        I = t._get(y.id);
                    if (I) {
                        var S = I[C];
                        (_.value = S), (_.element = s[k]), (_.name = C), !1 !== FamilyTree.events.publish("label", [t, _]) && (FamilyTree.isNEU(_.value) || FamilyTree.isNEU(_.element) || (w += _.element.replace("{val}", _.value)));
                    }
                }
                "" != w && ((w = FamilyTree.linkFieldsOpenTag.replace("{x}", b.x).replace("{y}", b.y).replace("{rotate}", 0) + w + FamilyTree.grCloseTag), d.push(w)), d.push(FamilyTree.grCloseTag);
            }
            return d.join("");
        },
        ...
        for (var i, r, a, n, l, o = "", s = 0; s < this.config.clinks.length; s++) {
            ...
            if (c && -1 != t.res.visibleNodeIds.indexOf(c.id) && m && -1 != t.res.visibleNodeIds.indexOf(m.id)) {
                ...
                switch (this.config.orientation) {
                    case FamilyTree.orientation.top:
                    case FamilyTree.orientation.top_left:
                        b <= T ? ((x = 1), (y.x = b + c.w / 10), (g.x = T - m.w / 10)) : ((x = -1), (y.x = b - c.w / 10), (g.x = T + m.w / 10)),
                ...
                var k = FamilyTree.clinkTemplates[w],
                    C = ((i = y), (a = _), (n = void 0), (l = void 0), (n = ((r = g).x - i.x) / 2 + i.x), (l = (r.y - i.y) / 2 + i.y), { x: (n - a.x) / 2 + a.x, y: (l - a.y) / 2 + a.y });
                d.label && (o += k.label.replace("{x}", C.x).replace("{y}", C.y).replace("{val}", d.label));
                var I = "M" + y.x + "," + y.y + "C" + y.x + "," + y.y + " " + _.x + "," + _.y + " " + g.x + "," + g.y;
                (o +=
    ...
    (FamilyTree.prototype._slinks = function (e, t) {
        ...
        function n(t, n, l) {
            ...
            var u = { p: t.x + t.w / 2 + h.expandCollapseSize, q: t.y, r: t.x + t.w / 2 + h.expandCollapseSize, s: a.minY + f },
                y = t.level;
            t.subLevels && (y += t.subLevels);
            var g = n.level;
            if ((n.subLevels && (g += n.subLevels), y == g))
                ...
                for (var b = t; null == d; ) {
                    var T = !1,
                        ...
                        F = v.leftNeighbor,
                        x = v.rightNeighbor;
                    if ((v.id == n.id ? (d = v) : FamilyTree._intersects(v, u, e.config) && ((u = FamilyTree._addPoint(v, s, e.config, u, c)), (T = !0)), v.id != n.id)) {
                        for (; F; ) {
                            if (F.id == n.id) {
                                d = F;
                                break;
                            }
                            FamilyTree._intersects(F, u, e.config) && ((u = FamilyTree._addPoint(F, s, e.config, u, c)), (T = !0)), (F = F.leftNeighbor);
                        }
                        for (; x; ) {
                            if (x.id == n.id) {
                                d = x;
                            ...
                            FamilyTree._intersects(x, u, e.config) && ((u = FamilyTree._addPoint(x, s, e.config, u, c)), (T = !0)), (x = x.rightNeighbor);
                        }
                    }
                    if (!T) {
                        var _ = s[s.length - 1][0],
                            w = 0;
                        if (v.parent)
                            switch (((f = p.levelSeparation), (v.parent.layout != FamilyTree.mixed && v.parent.layout != FamilyTree.tree) || (f = p.mixedHierarchyNodesSeparation), p.orientation)) {
                                case FamilyTree.orientation.top:
                                case FamilyTree.orientation.top_left:
                                    w = v.parent.y + v.parent.h + f * (2 / 3);
                                    break;
                                case FamilyTree.orientation.bottom:
                                case FamilyTree.orientation.bottom_left:
                                    w = v.parent.y - f * (2 / 3);
                                ...
                                case FamilyTree.orientation.left:
                                case FamilyTree.orientation.left_top:
                                    (_ = v.parent.x + v.parent.w + f * (2 / 3)), (w = s[s.length - 1][1]);
                                    break;
                                case FamilyTree.orientation.right:
                                case FamilyTree.orientation.right_top:
                                    (_ = v.parent.x - f * (2 / 3)), (w = s[s.length - 1][1]);
                            }
                        s.push([_, w]);
                    }
                    b = v;
            ...
            switch ((h = FamilyTree.slinkTemplates[k]).labelPosition) {
                ...
                case "middle":
                    ...
                    (C = s[N]), (I = s[N - 1]), (S = { x: (C[0] + I[0]) / 2, y: (C[1] + I[1]) / 2 });
                    break;
                case "end":
            ...
            var M = s.join(" ");
            if (o.label) {
                var L = h.label.replace("{x}", S.x).replace("{y}", S.y).replace("{val}", o.label),
            ...
            (i +=
                ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", t.id).replace("{to}", n.id) +
                h.link.replaceAll("{d}", M) +
                '<path stroke="transparent" stroke-width="15" fill="none" d="' +
                M +
                '" />'),
    ...
    FamilyTree.events.on("redraw", function (e, t) {
        if (e.config.miniMap) {
            ...
            var a = e.response.boundary.maxX - e.response.boundary.minX,
                ...
                l = Math.min(i.width / a, i.height / n),
                o = (i.width - a * l) / 2,
                s = (i.height - n * l) / 2;
            r.clearRect(0, 0, i.width, i.height), r.translate(-e.response.boundary.minX * l + o, -e.response.boundary.minY * l + s), r.scale(l, l);
            var d = 0,
                c = [];
            !(function e(t, i) {
                if (Array.isArray(i)) for (var a = 0; a < i.length; a++) e(t, i[a]);
                else {
                    (r.fillStyle = FamilyTree.miniMap.colors[3]), r.beginPath(), (r.lineWidth = "0.5"), r.fillRect(i.x, i.y, i.w, i.h), r.strokeRect(i.x, i.y, i.w, i.h);
                    for (a = 0; a < i.stChildrenIds.length; a++)
                        d++,
                            c.includes(i.id) ||
                                (1 == d ? (r.fillStyle = FamilyTree.miniMap.colors[0]) : 2 == d ? (r.fillStyle = FamilyTree.miniMap.colors[1]) : 3 == d && (r.fillStyle = FamilyTree.miniMap.colors[2]),
                                r.beginPath(),
                            ...
                            d--;
                    for (a = 0; a < i.childrenIds.length; a++) e(t, t.getNode(i.childrenIds[a]));
                }
            })(e, e.roots);
            var m = e.getViewBox()[0],
                ...
                h = e.getViewBox()[2],
                f = e.getViewBox()[3];
            (r.lineWidth = 0.5 / l), (r.strokeStyle = "#f57c00"), r.strokeRect(m, p, h, f), (r.globalAlpha = 0.4), (r.fillStyle = FamilyTree.miniMap.selectorBackgroundColor), r.fillRect(m, p, h, f);
        }
    }),
    (FamilyTree.miniMap = {}),
    (FamilyTree.miniMap._getCanvas = function (e) {
        if (!(t = e.element.querySelector("[" + FamilyTree.attr.id + '="mini-map"]'))) {
            var t;
            ((t = document.createElement("canvas")).width = 250), (t.height = 140), t.setAttribute(FamilyTree.attr.id, "mini-map"), (t.style.display = "inline-block"), (t.style.backgroundColor = FamilyTree.miniMap.backgroundColor);
            var i = document.createElement("div");
    ...
    (FamilyTree._search.search = function (e, t, i, r, a, n) {
        ...
        o = o.filter(function (e, t, i) {
            return i.indexOf(e) === t;
        });
        for (var s = {}, d = 0; d < e.length; d++)
            for (var c = e[d], m = 0; m < i.length; m++) {
                var p = i[m];
                if (!FamilyTree.isNEU(c[p])) {
                    var h = c[p];
                    if (null != (t = FamilyTree._search.searchAndComputeScore(o, h, p, n))) {
                        var f = c.id;
                        if (s[f]) {
                            if (s[f] && s[f] < t.__score) {
                                s[f] = t.__score;
                                for (var u = l.length - 1; u >= 0; u--) l[u].id == f && l.splice(u, 1);
                                FamilyTree._search.addNodeToResult(l, r, c, t, p, a);
                            }
                        } else (s[f] = t.__score), FamilyTree._search.addNodeToResult(l, r, c, t, p, a);
                    }
                }
            }
        return (
    ...
    (FamilyTree._search.searchAndComputeScore = function (e, t, i, r) {
        ...
        if (n.length) {
            ...
            for (var c = 0; c < n.length; c++)
                if (((o += n[c].length), n[c].start < s && (s = n[c].start), c >= 1 && n[c - 1].start > n[c].start)) {
                    d = 0;
                    break;
                }
        }
        ...
        0 != s && (p = 100 - s / l);
        var h = 0;
        r && r[i] && (h = r[i]), m > 0 && (m = (m / 100) * 20), p > 0 && (p = (p / 100) * 20), d > 0 && (d = (d / 100) * 20), h > 0 && (h = (h / 100) * 40);
        var f = parseInt(m + p + d + h);
        f > 100 && (f = 100),
            n.sort(function (e, t) {
                return e.start < t.start ? -1 : e.start > t.start ? 1 : 0;
            });
        var u = t;
        for (c = n.length - 1; c >= 0; c--) u = (u = u.insert(n[c].start + n[c].length, "</mark>")).insert(n[c].start, "<mark>");
    ...
    (FamilyTree._search.searchIndexesOf = function (e, t) {
        ...
        if (!FamilyTree.isNEU(e))
            for (var r = 0; r < t.length; r++) {
                var a = t[r];
                if (!FamilyTree.isNEU(a)) for (var n = 0; (n = e.indexOf(a, n)) > -1; ) i.push({ length: a.length, start: n }), (n += a.length);
            }
        return (
            i.sort(function (e, t) {
    ...
    FamilyTree.events.on("redraw", function (e, t) {
        if (e.config.state) {
            ...
            !(function e(t) {
                ...
                FamilyTree.state._put(e.width(), e.height(), e.response.viewBox, i, r, e.response.adjustify, e.config.state);
        }
    }),
    (FamilyTree.state = {}),
    (FamilyTree.state._buildStateNames = function (e) {
        return { paramScale: e + "-scale", paramX: e + "-x", paramY: e + "-y", paramExp: e + "-exp", paramMin: e + "-min", paramAdjustify: e + "-adjustify" };
    }),
    (FamilyTree.state._put = function (e, t, i, r, a, n, l) {
        if (l) {
            var o = FamilyTree.state._buildStateNames(l.name),
                s = { scale: Math.min(e / i[2], t / i[3]), x: i[0], y: i[1], exp: r, min: a, adjustify: n };
            if (l.writeToUrlParams) {
                var d = new URLSearchParams(window.location.search);
                d.has(o.paramScale) ? d.set(o.paramScale, s.scale) : d.append(o.paramScale, s.scale),
                    d.has(o.paramX) ? d.set(o.paramX, s.x) : d.append(o.paramX, s.x),
                    d.has(o.paramY) ? d.set(o.paramY, s.y) : d.append(o.paramY, s.y),
                    d.has(o.paramExp) ? d.set(o.paramExp, s.exp.join("*")) : d.append(o.paramExp, s.exp.join("*")),
                    d.has(o.paramMin) ? d.set(o.paramMin, s.min.join("*")) : d.append(o.paramMin, s.min.join("*")),
                    d.has(o.paramAdjustify) ? d.set(o.paramAdjustify, s.adjustify.x + "*" + s.adjustify.y) : d.append(o.paramAdjustify, s.adjustify.x + "*" + s.adjustify.y),
            ...
            l.writeToIndexedDB &&
                ...
                l.writeToLocalStorage && FamilyTree.localStorage.setItem(l.name, JSON.stringify(s));
        }
    }),
        ...
        if (e) {
            ...
            if (e.readFromUrlParams) {
                ...
                if (n.has(a.paramScale) && n.has(a.paramX) && n.has(a.paramY) && n.has(a.paramExp) && n.has(a.paramMin) && n.has(a.paramAdjustify)) {
                    ...
                    ((m = [])[0] = s), (m[1] = d), (m[2] = t / o), (m[3] = i / o), (l.vb = m), (l.scale = o), (l.x = s), (l.y = d), (l.exp = n.get(a.paramExp).split("*")), (l.min = n.get(a.paramMin).split("*"));
    ...
    (FamilyTree.prototype.magnify = function (e, t, i, r, a) {
        ...
        if (n || l) {
            ...
            if ((o && (null != o.timer && clearInterval(o.timer), null != o.timerBack && clearInterval(o.timerBack), l.setAttribute("transform", "matrix(" + o.transformStart.toString() + ")"), FamilyTree._magnify[e]), i))
    ...
    FamilyTree.events.on("init", function (e, t) {
        e.config.enableKeyNavigation &&
            (e._addEvent(window, "keydown", e._windowKeyDownHandler), FamilyTree.isNEU(e._keyNavigationActiveNodeId) && e.roots && e.roots.length && ((e._keyNavigationActiveNodeId = e.roots[0].id), e.center(e._keyNavigationActiveNodeId)));
    }),
    ...
    FamilyTree.events.on("click", function (e, t) {
        e.config && e.config.enableKeyNavigation && ((e._keyNavigationActiveNodeId = t.node.id), e.center(t.node.id));
    }),
    ...
    (FamilyTree.elements.textbox = function (e, t, i, r) {
        ...
        // if (a.id = "gender") {a.doNotRender=true};
    ...
    (FamilyTree.elements.checkbox = function (e, t, i, r) {
        ...
        return {
            html: `<div class="bft-form-field"  style="min-width: ${i};" >\n                        <label class="bft-checkbox" data-bft-input="" ${a.disabledAttribute}>\n                            <input ${n} ${l} data-binding="${a.binding}" type="checkbox"><span class="bft-checkbox-checkmark" type="checkbox"></span>${a.label}\n                        </label>\n                    </div>`,
            id: a.id,
            value: n,
        };
    }),
            ...
            : {
                  html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${a.id}">${
                      ...
                      for (var e = "", t = 0; t < a.options.length; t++) {
                          var i = a.options[t];
                          e += `<option ${i.value == a.value ? "selected" : ""} value="${i.value}">${i.text}</option>`;
                      }
                      return e;
                  })()}                           \n                        </select>\n                    </div>\n                </div>`,
                  id: a.id,
            ...
            n && (a.value || ("select-one" == a.type && a.selectedOptions && a.selectedOptions.length && "" == a.selectedOptions[0].value && a.selectedOptions[0].innerHTML)) && n.classList.add("hasval"),
                ...
                "checkbox" != a.type.toLowerCase() &&
                    a.addEventListener("blur", function () {
                        var e = this.parentNode.querySelector("label");
                        e.classList.remove("focused"), this.value || "date" == this.type ? e.classList.add("hasval") : e.classList.remove("hasval");
                    });
        }
    }),
    ...
    (FamilyTree.prototype.showTreeMenu = function (e) {
        ...
        for (g = 0; g < o.length; g++)
            if ((o[g].fid == c.id && FamilyTree.isNEU(o[g].mid)) || (o[g].mid == c.id && FamilyTree.isNEU(o[g].fid))) {
                var b = { id: "_ft_partner_for_single_child", pids: [e], templateName: "partner", _ft_method: "addPartnerAndParentNodes", _ft_childId: o[g].id, _ft_partnerData: { pids: [e] }, _ft_id: e };
                "male" == c.gender ? ((b.templateName = "wife"), (b._ft_partnerData.gender = "female")) : "female" == c.gender && ((b.templateName = "husband"), (b._ft_partnerData.gender = "male")),
                    c.pids.push(b.id),
                    m.push(b),
                    o[g].fid == c.id ? (o[g].mid = "_ft_partner_for_single_child") : o[g].mid == c.id && (o[g].fid = "_ft_partner_for_single_child"),
                    m.push(o[g]);
            }
        var T = { nodes: m, node: c };
        FamilyTree.events.publish("node-tree-menu-show", [this, T]), T.nodes.push(T.node), (this.config.nodes = T.nodes), (c = this.get(e));
        var v = this;
    ...
    (FamilyTree.filterUI.prototype.addFilterTag = function (e) {
        ...
        var t = this.instance.element.querySelectorAll("[data-filter-menu]");
        if (t)
            for (var i = 0; i < t.length; i++) {
                var r = e[t[i].getAttribute("data-filter-menu")];
                if (!FamilyTree.isNEU(r)) {
                    var a = t[i].querySelector(`[name="${r}"]`);
    ...
    (FamilyTree.filterUI.prototype.update = function () {
        if (this.instance.config.filterBy) {
            var e = Array.isArray(this.instance.config.filterBy),
                t = this,
                i = this.instance.element.querySelector("[data-filter]");
            i && i.parentNode.removeChild(i),
                (i = document.createElement("div")).setAttribute("data-filter", ""),
                (i.style.position = "absolute"),
                i.setAttribute("class", "bft-filter"),
                (i.style.top = this.instance.config.padding + "px"),
                (i.style.left = this.instance.config.padding + "px");
            for (var r = "", a = 0; a < this.instance.editUI.fields.length; a++)
                ((!e &&
                    "tags" != this.instance.editUI.fields[a] &&
                    "id" != this.instance.editUI.fields[a] &&
                    "pid" != this.instance.editUI.fields[a] &&
                    "ppid" != this.instance.editUI.fields[a] &&
                    "stpid" != this.instance.editUI.fields[a]) ||
                    (e && this.instance.config.filterBy.has(this.instance.editUI.fields[a]))) &&
                    (r += `<div data-filter-field="${this.instance.editUI.fields[a]}">${this.instance.editUI.fields[a]}</div>`);
            (i.innerHTML = `<div>${r}</div>`),
                i.addEventListener("click", function (e) {
                    if (e.target.hasAttribute("data-filter-close") || e.target.hasAttribute("data-filter-field")) {
                        for (var i = e.target.getAttribute("data-filter-field"), r = t.instance.element.querySelectorAll("[data-filter-menu]"), a = 0; a < r.length; a++) r[a].style.display = "none";
                        var n = t.instance.element.querySelectorAll(".filter-field-selected");
                        for (a = 0; a < n.length; a++) n[a].classList.remove("filter-field-selected");
                        var l = t.instance.element.querySelector("[data-filter-close]");
                        if ((l && l.parentNode.removeChild(l), e.target.hasAttribute("data-filter-close"))) return;
                        if (!e.target.hasAttribute("data-filter-field")) return;
                        var o = t.instance.element.querySelector(`[data-filter-menu="${i}"]`);
                        if (!o) {
                            var s = `<div>\n                                        <input data-all type="checkbox" id="all_${i}" name="all_${i}" checked>\n                                        <label for="all_${i}">[All]</label>\n                                    </div>`,
                                d = [];
                            for (a = 0; a < t.instance.config.nodes.length; a++) {
                                var c = t.instance.config.nodes[a][i];
                                FamilyTree.isNEU(c) ||
                                    d.has(c) ||
                            ...
                            ((o = document.createElement(
                                ...
                                o.setAttribute("data-filter-menu", i),
                                o.classList.add("bft-filter-menu"),
                                e.target.parentNode.parentNode.appendChild(o);
                            var m = o.querySelectorAll("input");
                            for (a = 0; a < m.length; a++)
                                m[a].addEventListener("change", function (e) {
                                    if (e.target.hasAttribute("data-all")) for (var i = e.target.parentNode.parentNode.querySelectorAll("input"), r = 0; r < i.length; r++) i[r] != e.target && (i[r].checked = e.target.checked);
                                    t.instance.draw();
                                });
                        }
                        (o.style.display = "block"),
                            e.target.classList.add("filter-field-selected"),
                            (l = document.createElement("div")).classList.add("close"),
                            (l.innerHTML = "x"),
                            l.setAttribute("data-filter-close", ""),
                            e.target.parentNode.appendChild(l);
                    }
                }),
                this.instance.element.appendChild(i);
        }
    }),
    void 0 === FamilyTree && (FamilyTree = {}),
    ...
    (FamilyTree.remote._setPositions = function (e, t, i, r) {
        ...
        if ((FamilyTree.LIMIT_NODES || (s.l = !0), null != FamilyTree.remote._fromReqDTO))
            ...
            d
                ? FamilyTree.remote._proceed(e, JSON.parse(d), r, i)
